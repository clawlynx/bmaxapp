  ...
  return (
    <div className=" p-7 max-w-6xl mx-auto">
      <div className="flex items-center justify-start gap-3 h-24">
        ...
        <h1 className="text-4xl font-semibold">Bemax TS Portal</h1>
      </div>
      <div className=" grid lg:grid-cols-2 max-w-6xl landingPage mt-24">
        <div>
          <h1 className=" text-blue-700 font-semibold text-4xl mb-2">
            Welcome!!{" "}
          </h1>
          <h2 className="mb-2 text-3xl">
            the <span>Teachers-Students</span> Portal
          </h2>
          <p className=" leading-7 mb-8 text-lg">
